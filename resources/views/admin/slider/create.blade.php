                            ...
                            <form class="form-horizontal" action="{{ route('admin.slider.store') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="card-body">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                        <input type="text" class="form-control" id="fname" name="title" placeholder="Ingresar El Titilo Del Slider Aquí">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="fname" class="col-sm-3 text-right control-label col-form-label">Ingrese El Sub Titulo Del Slider</label>
                                        <div class="col-sm-9">
                                        <input type="text" class="form-control" id="fname" name="sub_title" placeholder="Ingresar El subtitulo Aquí">
                                        </div>
                                    </div>
                                    <div class="form-group row">
