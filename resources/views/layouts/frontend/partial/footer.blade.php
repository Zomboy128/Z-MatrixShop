				...
				<ul id="flexiselDemo1">
					<li>
						<div class="w3l-specilamk">
							<div class="speioffer-agile">
								<a href="single.html">
									<img src="{{ asset('assets/frontend/images/s1.jpg') }}" alt="">
								</a>
							</div>
					...
					<li>
						<div class="w3l-specilamk">
							<div class="speioffer-agile">
								<a href="single.html">
									<img src="{{ asset('assets/frontend/images/s4.jpg') }}" alt="">
								</a>
							</div>
							<div class="product-name-w3l">
								<h4>
					...
					<li>
						<div class="w3l-specilamk">
							<div class="speioffer-agile">
								<a href="single.html">
									<img src="{{ asset('assets/frontend/images/s2.jpg') }}" alt="">
								</a>
							</div>
							<div class="product-name-w3l">
								<h4>
					...
					<li>
						<div class="w3l-specilamk">
							<div class="speioffer-agile">
								<a href="single2.html">
									<img src="{{ asset('assets/frontend/images/s3.jpg') }}" alt="">
								</a>
							</div>
							<div class="product-name-w3l">
								<h4>
					...
					<li>
						<div class="w3l-specilamk">
							<div class="speioffer-agile">
								<a href="single.html">
									<img src="{{ asset('assets/frontend/images/s8.jpg') }}" alt="">
								</a>
							</div>
							<div class="product-name-w3l">
								<h4>
					...
					<li>
						<div class="w3l-specilamk">
							<div class="speioffer-agile">
								<a href="single2.html">
									<img src="{{ asset('assets/frontend/images/s6.jpg') }}" alt="">
								</a>
							</div>
							<div class="product-name-w3l">
								<h4>
					...
					<li>
						<div class="w3l-specilamk">
							<div class="speioffer-agile">
								<a href="single.html">
									<img src="{{ asset('assets/frontend/images/s5.jpg') }}" alt="">
								</a>
							</div>
							<div class="product-name-w3l">
								<h4>
					...
					<li>
						<div class="w3l-specilamk">
							<div class="speioffer-agile">
								<a href="single2.html">
									<img src="{{ asset('assets/frontend/images/s9.jpg') }}" alt="">
								</a>
							</div>
							<div class="product-name-w3l">
								<h4>
 ...
 <div class="footer-top">
		<div class="container-fluid">
			...
			<div class="col-xs-4 w3l-rightmk">
				<img src="{{ asset('assets/frontend/images/tab3.png') }}" alt=" ">
			</div>
			...
			<div class="footer-info w3-agileits-info">
				...
				<div class="col-sm-2 footer-grids  w3l-socialmk">
					...
					<div class="agileits_app-devices">
						...
						<a href="#">
							<img src="{{ asset('assets/frontend/images/2.png') }}" alt="">
						</a>
						<div class="clearfix"> </div>
					</div>
				</div>
...
Cuidado del bebé, suministros para mascotas, atención médica y otros productos diarios necesarios. El descuento puede variar de un producto a otro.</p>
				...
				<div class="sub-some child-momu">
					...
					<ul>
						<li>
							<img src="{{ asset('assets/frontend/images/pay2.png') }}" alt="">
						</li>
						<li>
							<img src="{{ asset('assets/frontend/images/pay5.png') }}" alt="">
						</li>
						<li>
							<img src="{{ asset('assets/frontend/images/pay1.png') }}" alt="">
						</li>
						<li>
							<img src="{{ asset('assets/frontend/images/pay4.png') }}" alt="">
						</li>
						<li>
							<img src="{{ asset('assets/frontend/images/pay6.png') }}" alt="">
						</li>
						<li>
							<img src="{{ asset('assets/frontend/images/pay3.png') }}" alt="">
						</li>
						<li>
							<img src="{{ asset('assets/frontend/images/pay7.png') }}" alt="">
						</li>
						<li>
							<img src="{{ asset('assets/frontend/images/pay8.png') }}" alt="">
						</li>
						<li>
							<img src="{{ asset('assets/frontend/images/pay9.png') }}" alt="">
						</li>
					</ul>
				</div>
				<!-- //payment -->
	...
	<script src="{{ asset('assets/frontend/js/jquery.flexisel.js') }}"></script>
	<script>
		$(window).load(function () {
	...
	<script src="{{ asset('assets/frontend/js/move-top.js') }}"></script>
