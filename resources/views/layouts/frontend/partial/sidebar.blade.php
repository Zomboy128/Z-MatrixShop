<!-- product left -->
			<div class="side-bar col-md-3">
				...
				<div class="deal-leftmk left-side">
					...
					<div class="special-sec1">
						<div class="col-xs-4 img-deals">
							<img src="{{ asset('assets/frontend/images/d1.jpg') }}" alt="">
						</div>
						<div class="col-xs-8 img-deal1">
					...
					<div class="special-sec1">
						<div class="col-xs-4 img-deals">
							<img src="{{ asset('assets/frontend/images/d4.jpg') }}" alt="">
						</div>
						<div class="col-xs-8 img-deal1">
							<h3>Tata Salt</h3>
					...
					<div class="special-sec1">
						<div class="col-xs-4 img-deals">
							<img src="{{ asset('assets/frontend/images/d5.jpg') }}" alt="">
						</div>
						<div class="col-xs-8 img-deal1">
					...
					<div class="special-sec1">
						<div class="col-xs-4 img-deals">
							<img src="{{ asset('assets/frontend/images/d3.jpg') }}" alt="">
						</div>
						<div class="col-xs-8 img-deal1">
